...
export class PeerCouchDB extends Peer {
    ...
    private _pollIntervalMs = 5000;   // 5s between polls
    private _pollTimeoutMs = 50000;   // 50s HTTP timeout per poll (under CF's ~100s)
    private _useShortPolling = true;  // Hardcoded ON for our Cloudflare Tunnel setup
